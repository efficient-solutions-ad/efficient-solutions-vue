...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: CONST_OBJECT_LINKS_PAGES.store,
      name: CONST_OBJECT_TEXT_PAGES.store,
      component: StoreComp
    },
    {
      path: CONST_OBJECT_LINKS_PAGES.contact,
      name: CONST_OBJECT_TEXT_PAGES.contact,
      component: ContactComp
    },
    {
      path: CONST_OBJECT_LINKS_PAGES.reviews,
      name: CONST_OBJECT_TEXT_PAGES.reviews,
      component: ReviewsComp
    },
    {
      path: CONST_OBJECT_LINKS_PAGES.about,
      name: CONST_OBJECT_TEXT_PAGES.about,
      component: AboutComp
    },
    {
